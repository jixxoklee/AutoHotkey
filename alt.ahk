...
accel_rate := 1.2  ; 가속도 비율 (1보다 크면 가속, 1이면 일정 속도)
...
; 마우스 클릭
>!u::Click()          ; 오른쪽 Alt + u를 누르면 클릭
>!o::Click("right")   ; 오른쪽 Alt + o를 누르면 우클릭

>!9::  ; 오른쪽 Alt + 9를 누르면 위로 스크롤
{
